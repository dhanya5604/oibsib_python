...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            speak("I have been created by Dhanya.")
            ...
            speak("Thanks to Dhanya. further It's a secret")

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by Dhanya")

        elif 'reason for you' in query:
            speak("I was created as a Minor project by Miss Dhanya ")
